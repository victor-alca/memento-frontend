...
class StroopTestPage extends StatefulWidget {
  ...
  const StroopTestPage({super.key, this.patientId, this.doctorId});
...
class _StroopTestPageState extends State<StroopTestPage> {
  ...
  void _processarResposta(String resposta) {
    ...
    bool acertou =
        resposta.contains(corCorretaTexto.toLowerCase()) ||
        ...
        body: const Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              Text('Configurando microfone...', style: TextStyle(fontSize: 18)),
            ],
          ),
        ),
      );
